...
#define LV_FONT_CUSTOM_DECLARE              LV_FONT_DECLARE(Font20)\
                                            LV_FONT_DECLARE(Font32)\
...
#define LV_USE_DROPDOWN                     0   /* 依赖: lv_label */
...
#define LV_USE_ROLLER                       0  /* 依赖: lv_label */
#if LV_USE_ROLLER
    #define LV_ROLLER_INF_PAGES             7  /* 当滚筒无限时，额外的“页数” */
#endif

#define LV_USE_SLIDER                       0  /* 依赖: lv_bar*/

#define LV_USE_SWITCH                       0
#define LV_USE_TEXTAREA                     0  /* 依赖: lv_label*/
