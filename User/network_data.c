 ...
 */
AI_INTERNAL_API
AI_STATIC void s_network_copy_weights(void)
{
  memcpy((void *)AI_NETWORK_DATA_WEIGHTS_ADDR_DST, (const void*)AI_NETWORK_DATA_WEIGHTS_ADDR_SRC, 2274644);
}
...
{
  s_network_copy_weights();
  return AI_HANDLE_PTR(AI_NETWORK_DATA_WEIGHTS_ADDR_DST);
}
