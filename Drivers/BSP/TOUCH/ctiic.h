...
#define CT_IIC_SCL_GPIO_PORT            GPIOE
#define CT_IIC_SCL_GPIO_PIN             GPIO_PIN_12
#define CT_IIC_SCL_GPIO_CLK_ENABLE()    do{ __HAL_RCC_GPIOE_CLK_ENABLE(); }while(0)   /* PE口时钟使能 */

#define CT_IIC_SDA_GPIO_PORT            GPIOE
#define CT_IIC_SDA_GPIO_PIN             GPIO_PIN_14
#define CT_IIC_SDA_GPIO_CLK_ENABLE()    do{ __HAL_RCC_GPIOE_CLK_ENABLE(); }while(0)   /* PE口时钟使能 */
