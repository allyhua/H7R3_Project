...
#define T_CS_GPIO_PIN                   GPIO_PIN_15
#define T_CS_GPIO_CLK_ENABLE()          do{ __HAL_RCC_GPIOE_CLK_ENABLE(); }while(0)   /* 所在IO口时钟使能 */

#define T_MISO_GPIO_PORT                GPIOE
#define T_MISO_GPIO_PIN                 GPIO_PIN_13
#define T_MISO_GPIO_CLK_ENABLE()        do{ __HAL_RCC_GPIOE_CLK_ENABLE(); }while(0)   /* 所在IO口时钟使能 */

#define T_MOSI_GPIO_PORT                GPIOE
#define T_MOSI_GPIO_PIN                 GPIO_PIN_14
#define T_MOSI_GPIO_CLK_ENABLE()        do{ __HAL_RCC_GPIOE_CLK_ENABLE(); }while(0)   /* 所在IO口时钟使能 */

#define T_CLK_GPIO_PORT                 GPIOE
#define T_CLK_GPIO_PIN                  GPIO_PIN_12
#define T_CLK_GPIO_CLK_ENABLE()         do{ __HAL_RCC_GPIOE_CLK_ENABLE(); }while(0)   /* 所在IO口时钟使能 */
