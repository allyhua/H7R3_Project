 ...
 * @version     V1.0
 * @date        2022-06-21
 * @brief       ATK-MC2640妯″潡瀵勫瓨鍣ㄩ厤缃?
 * @license     Copyright (c) 2020-2032, 骞垮窞甯傛槦缈肩數瀛愮鎶€鏈夐檺鍏徃
 ****************************************************************************************************
 * @attention
 *
 * 瀹為獙骞冲彴:姝ｇ偣鍘熷瓙 闃挎尝缃?H743寮€鍙戞澘
...
/* 閫夋嫨ATK-MC2640妯″潡鍚敤鐨勫瘎瀛樺櫒鍧?
 * 褰撳瘎瀛樺櫒0xFF=00鏃讹紝鍚敤DSP瀵勫瓨鍣ㄥ潡
 * 褰撳瘎瀛樺櫒0xFF=01鏃讹紝鍚敤Sensor瀵勫瓨鍣ㄥ潡
 */
#define ATK_MC2640_REG_BANK_SEL  ATK_MC2640_REG_DSP_RA_DLMT

/* ATK-MC2640妯″潡DSP瀵勫瓨鍣ㄥ潡 */
